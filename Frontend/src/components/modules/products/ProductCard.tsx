    ...
    return (
        ...
        >
            ...
            <div className="p-5 space-y-3">
                ...
                {/* Name */}
                <h3 className="font-semibold text-base leading-snug line-clamp-2 text-foreground group-hover:text-primary transition-colors duration-200">
                    {product.name}
                </h3>
                ...
                {/* Shop Info */}
                {product.shop?.name && (
                    <div className="flex items-center gap-1.5 text-xs text-muted-foreground min-w-0 pt-1">
                        <Store className="h-3.5 w-3.5 shrink-0 text-primary/70" />
                        <span className="truncate font-medium hover:text-primary transition-colors duration-150">{product.shop.name}</span>
                    </div>
                )}
